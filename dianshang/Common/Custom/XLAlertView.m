...
- (instancetype)initWithTitle:(NSString *)title message:(NSString *)message sureBtn:(NSString *)sureTitle cancleBtn:(NSString *)cancleTitle
{
    if (self == [super init]) {
        ...
        UIButton *closeBtn = [[UIButton alloc] initWithFrame:CGRectMake(AlertW-closeBtnW, 0, closeBtnW, closeBtnH)];
        [closeBtn setImage:[UIImage imageNamed:@"icon_close_black"] forState:UIControlStateNormal];
        //closeBtn.center = CGPointMake(CGRectGetMaxX(self.alertView.frame)-closeBtnW*0.5, self.alertView.frame.origin.y+closeBtnH*0.5);
