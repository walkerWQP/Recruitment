...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    NSDictionary *userDict = model.message.ext;
    NSString *userid = [userDict objectForKey:kHXUserID];
    ...
    if (userinfo != nil) {
        ...
        userheadpath = userinfo.userHeadPath;
    }
    if (userheadpath) {
        [self.avatarView sd_setImageWithURL:[NSURL URLWithString:userheadpath] placeholderImage:model.avatarImage];
    } else {
