...
{
    NSDictionary *msgExt = [self yqMessageExtHandle:messageExt];
    NSString *willSendText = [EaseConvertToCommonEmoticonsHelper convertToCommonEmoticons:text];
    EMTextMessageBody *body = [[EMTextMessageBody alloc] initWithText:willSendText];
    NSString *from = [[EMClient sharedClient] currentUsername];
    EMMessage *message = [[EMMessage alloc] initWithConversationID:toUser from:from to:toUser body:body ext:msgExt];
                     ...
                     cmdParams:(NSArray *)params
{
    ...
    NSString *from = [[EMClient sharedClient] currentUsername];
    EMMessage *message = [[EMMessage alloc] initWithConversationID:to from:from to:to body:body ext:msgExt];
    message.chatType = messageType;
                              ...
                              messageExt:(NSDictionary *)messageExt
{
    ...
    return [self sendImageMessageWithImageData:data to:to messageType:messageType messageExt:msgExt];
}
...
/// 处理消息扩展 添加公共字段
+ (NSDictionary *)yqMessageExtHandle:(NSDictionary *)ext
{
    if (ext == nil) {
