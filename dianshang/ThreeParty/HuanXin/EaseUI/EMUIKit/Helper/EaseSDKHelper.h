...
/** @brief 视频通话回调刷新聊天消息通知 */
#define KNOTIFICATION_CHAT_RELOADMESSAGE @"EZCallReloadMessage"
/** @brief 视频通话回调刷新聊天列表消息通知 */
//#define KNOTIFICATION_CHATLIST_RELOADMESSAGE @"yqCallReloadMessageList"
